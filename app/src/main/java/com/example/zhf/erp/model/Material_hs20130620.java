...
/**
 * 
 * @author liujiancheng 杭水20130620信息类
 */
public class Material_hs20130620 {
	...
	public Material_hs20130620() {
	}

	public Material_hs20130620(String products, String classIfication, String classIficationSon,
							   String partsName, String mouldName, String drawName, int id, String code,
							   String name, String specifications, String suppliers, String storeAdress,
							   int needNumber, int projectNumber, int allNumber, int inventoryNumber,
							   int virtualNumber, String attribute, String bz, String nowState, int inStockNumber,
							   int remindNumber, int outStockNumber, int emergencyNumber, boolean isSelected) {
